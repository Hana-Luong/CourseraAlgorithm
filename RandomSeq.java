...
public class RandomSeq {
    ...
    public static void main(String[] args) {
        ...
        int n = Integer.parseInt(args[0]);      //arg[0] == number of numbers generated

        // for backward compatibility with Intro to Programming in Java version of RandomSeq
        if (args.length == 1) {                 //the number of numbers generated is 1-9
            // generate and print n numbers between 0.0 and 1.0
            for (int i = 0; i < n; i++) {
                double x = StdRandom.uniform();
                StdOut.println(x);              //go with default number of decimals
            }
        }
